<dependencies>
  <compile
      roots="androidx.databinding:viewbinding:8.8.2@aar,:@@:expo-modules-core::release,androidx.core:core-ktx:1.13.1@aar,org.jetbrains.kotlinx:kotlinx-coroutines-core-jvm:1.7.3@jar,androidx.core:core:1.13.1@aar,androidx.lifecycle:lifecycle-runtime:2.6.2@aar,androidx.lifecycle:lifecycle-common:2.6.2@jar,org.jetbrains.kotlinx:kotlinx-coroutines-android:1.7.3@jar,org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.8.20@jar,androidx.annotation:annotation-experimental:1.4.0@aar,org.jetbrains.kotlin:kotlin-stdlib:2.0.21@jar,org.jetbrains.kotlin:kotlin-stdlib-jdk7:2.0.21@jar,androidx.versionedparcelable:versionedparcelable:1.1.1@aar,androidx.arch.core:core-common:2.2.0@jar,androidx.collection:collection:1.0.0@jar,androidx.annotation:annotation:1.2.0@jar,org.jetbrains:annotations:13.0@jar">
    <dependency
  ...
  <package
      roots="androidx.databinding:viewbinding:8.8.2@aar,org.jetbrains.kotlin:kotlin-stdlib:2.0.21@jar,org.jetbrains.kotlin:kotlin-stdlib-jdk7:2.0.21@jar,androidx.annotation:annotation:1.2.0@jar,org.jetbrains:annotations:13.0@jar">
    <dependency
        name="androidx.databinding:viewbinding:8.8.2@aar"
        simpleName="androidx.databinding:viewbinding"/>
    <dependency
