    ...
    <div className="relative w-full h-[100dvh] overflow-hidden flex flex-col items-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.1) 40%, rgba(0,0,0,0.1) 60%, rgba(0,0,0,0.85) 100%)'
          }}
        />
      </div>
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center px-6 overflow-y-auto">
        ...
        <div className="text-center w-full">
          <h1
            ...
            style={{
              ...
              textShadow: '0 0 40px rgba(34, 197, 94, 0.6), 0 2px 10px rgba(0,0,0,0.9)',
            }}
          >
            Create Your Account
          </h1>
        ...
        >
          ...
          <div className="flex flex-col gap-5 px-5 sm:px-6">
            ...
            >
              <svg className="h-[20px] w-[20px] shrink-0 text-white/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
