...
export const config = {
  ...
  dark: vars({
    /* App Related Colors */
    "--color-app-widget-color": "27 30 44",
    "--color-app-base-color": "85 219 38",
    "--color-app-card-background-color": "27 30 44",
    "--color-app-secondary-color": "139 139 141",
    "--color-app-stopwatch-circular-progress-background-color": '129 129 129',
    /* Primary */
